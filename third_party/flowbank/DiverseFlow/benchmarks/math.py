        ...
        try:
            if self.is_digit(prediction) and self.is_digit(reference):
                ...
                if isclose(pred_val, ref_val, abs_tol=1e-3):
                    return True
                # Don't return False here — fall through to symbolic_equal
                # (handles cases like "28" vs "28\%" where parse_digits
                #  gives 28.0 vs 0.28 due to percentage conversion)
        except:
            pass
        ...
        def _parse(s):
            for f in [parse_latex, parse_expr]:
                try:
                    ...
                    pass
            # Fallback: normalize LaTeX and try parse_expr again
