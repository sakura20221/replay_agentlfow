...
def get_metagpt_package_root():
    ...
    package_root = Path(daao.__file__).parent.parent
...
SOURCE_ROOT = METAGPT_ROOT / "daao"
PROMPT_PATH = SOURCE_ROOT / "prompts"
SKILL_DIRECTORY = SOURCE_ROOT / "skills"
TOOL_SCHEMA_PATH = METAGPT_ROOT / "daao/tools/schemas"
TOOL_LIBS_PATH = METAGPT_ROOT / "daao/tools/libs"
