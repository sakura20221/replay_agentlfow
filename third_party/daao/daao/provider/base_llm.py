...
from daao.const import LLM_API_TIMEOUT, USE_CONFIG_TIMEOUT
from daao.logs import logger
from daao.schema import Message
from daao.utils.common import log_and_reraise
from daao.utils.cost_manager import CostManager, Costs
...
class BaseLLM(ABC):
    ...
    async def aask(
        ...
        # 下面才是真正的LLM调用函数，具体的实现在对应 LLM 的基类中
