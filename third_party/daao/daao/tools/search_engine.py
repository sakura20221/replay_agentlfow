...
from daao.tools import SearchEngineType
    ...
    def _process_extra(
        ...
        **kwargs,
        ...
        if self.engine == SearchEngineType.SERPAPI_GOOGLE:
            ...
            module = "daao.tools.search_engine_bing"
