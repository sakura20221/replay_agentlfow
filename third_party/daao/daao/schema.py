...
from daao.repo_parser import DotClassInfo
from daao.utils.common import any_to_str, any_to_str_set, import_class
from daao.utils.exceptions import handle_exception
from daao.utils.serialize import (
...
class Message(BaseModel):
    ...
    def check_instruct_content(cls, ic: Any) -> BaseModel:
        if ic and isinstance(ic, dict) and "class" in ic:
            if "mapping" in ic:
                ...
                actionnode_class = import_class("ActionNode", "daao.actions.action_node")  # avoid circular import
    ...
    def check_cause_by(cls, cause_by: Any) -> str:
        return any_to_str(cause_by if cause_by else import_class("UserRequirement", "daao.actions.add_requirement"))
    ...
    def ser_instruct_content(self, ic: BaseModel) -> Union[dict, None]:
        ...
        if ic:
            ...
            ic_type = str(type(ic))
            if "<class 'daao.actions.action_node" in ic_type:
