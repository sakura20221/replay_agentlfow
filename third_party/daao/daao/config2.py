...
from daao.configs.browser_config import BrowserConfig
from daao.configs.embedding_config import EmbeddingConfig
from daao.configs.file_parser_config import OmniParseConfig
from daao.configs.llm_config import LLMConfig, LLMType
from daao.configs.mermaid_config import MermaidConfig
from daao.configs.redis_config import RedisConfig
from daao.configs.s3_config import S3Config
from daao.configs.search_config import SearchConfig
from daao.configs.workspace_config import WorkspaceConfig
...
class Config(CLIParams, YamlModel):
    ...
    def from_home(cls, path):
        """Load config from ~/.maas/config2.yaml"""
