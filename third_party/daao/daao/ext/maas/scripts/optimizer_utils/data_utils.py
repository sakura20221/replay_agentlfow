...
from daao.utils.common import read_json_file, write_json_file
...
class DataUtils:
    ...
    def create_result_data(self, round: int, score: float, avg_cost=None, total_cost=None, token=None) -> dict:
