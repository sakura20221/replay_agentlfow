...
def extract_test_cases_from_jsonl(entry_point: str, dataset: CodeDataset = CodeDataset.HUMAN_EVAL, problem: str = None):
    if dataset == "SHARED_MBPP":
        file_path = "daao/ext/maas/data/shared_mbpp_public_test.jsonl"
        hardcoded_cases = {}
    elif dataset == CodeDataset.HUMAN_EVAL.value:
        file_path = "daao/ext/maas/data/humaneval_public_test.jsonl"
        ...
        file_path = "daao/ext/maas/data/mbpp_public_test.jsonl"
        hardcoded_cases = {
            "remove_odd": "",
            "replace_spaces": "",
            "snake_to_camel": "",
