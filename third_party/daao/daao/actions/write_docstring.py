...
Usage:
    python3 -m daao.actions.write_docstring <filename> [--overwrite] [--style=<docstring_style>]
...
Example:
    python3 -m daao.actions.write_docstring ./metagpt/software_company.py --overwrite False --style=numpy
...
from daao.utils.common import OutputParser, aread, awrite
from daao.utils.pycst import merge_docstring
