...
from CARD.tools.coding.executor_utils import function_with_timeout
from CARD.tools.coding.executor_types import ExecuteResult, Executor
...
def execute_code_get_return(code: str):
    local_vars = {}
    try:
        # --- shared-layer shim (agent_wf_v2) --- exec timeout v1
